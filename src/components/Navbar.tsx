  ...
  return (
    <nav
      className={cn(
        ...
        isScrolled
          ? "glass-effect backdrop-blur-md bg-white/80 dark:bg-black/70 shadow-sm"
          : "bg-transparent"
      )}
    >
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between">
          ...
          <Link
            to="/"
            className="flex justify-start text-2xl font-bold tracking-tight hover:opacity-80 transition-opacity"
          >
            <img
              src="./logo.png"
